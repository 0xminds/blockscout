defmodule Explorer.Migrator.HeavyDbIndexOperations.DropLogsBlockNumberAscIndexAscIndex do
  @moduledoc """
  ...
  def check_db_index_operation_progress do
    # todo
    HeavyDbIndexOperationHelper.check_index_creation_progress(@index_name)
  end

  @impl HeavyDbIndexOperation
  def db_index_exists_and_valid? do
    HeavyDbIndexOperationHelper.db_index_exists_and_valid?(@index_name)
  end
